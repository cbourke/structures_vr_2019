...
using UnityEngine;
public class BuildingMaterialAttributesOld
{
    public class Regions
    {
        ...
        public class UnitedStatesTypes
        {
            ...
            public string[] members = { STEEL, CONCRETE, ALUMINUM, COLDFORMED, REBAR, TENDON };

            public class SteelStandards
            {
            ...
            public class ConcreteStandards
            {
